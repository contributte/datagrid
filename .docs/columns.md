...
As mentioned above, there is one aggregation function prepared: `Ublaboo\DataGrid\AggregationFunction\FunctionSum`. You can implement whatever function you like, it just has to implement `Ublaboo\DataGrid\AggregationFunction\ISingleColumnAggregationFunction`.
